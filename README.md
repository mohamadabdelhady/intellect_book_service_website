...
<li>While programming tha audio player I had a problem with it that the play button will play the audio from the beginning after it has been paused, and I haven't found a solution to this problem yet.</li>
</ul>
<h2>
Licence
</h2>
