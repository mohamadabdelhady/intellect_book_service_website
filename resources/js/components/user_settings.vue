<template>
  <div>
    <div class="settings_tab">
      <a href="#" v-on:click.prevent="change_selected('profile')"
        ><span id="profile" class="ml-3">Profile settings</span></a
      >
      <a href="#" v-on:click.prevent="change_selected('subscription')">
        <span id="subscription" class="ml-3">subscription settings</span></a
      >
    </div>
    <hr />
    <div id="profile_area" style="display: none">
      <div class="row">
        <div
          class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-5"
        ...
        >
          ...
          >
            ...
            <input
              ...
              class="form-control"
              name="profimg"
              onchange="document.getElementById('change_prof').submit()"
            />
          </form>
          <button
            class="btn mt-3"
            ...
            onclick="
              ...
              document.getElementById('upload-img_prof').click();
            "
          >
            <span class="float-right">Change image</span
            ><i class="fas fa-user-circle fa-2x float-left"></i>
          </button>
        </div>
      ...
      <div>
        <div class="custom-control custom-switch">
          ...
          <label class="custom-control-label" for="customSwitch1"
            >Automatic subscription renewing</label
          >
        </div>
      </div>
      <button class="btn mt-2" type="button" data-toggle="modal" data-target="#myModal">
        Change your plan
      </button>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div>
                <div class="ml-5 mb-2 plan">
                  <div align="center">
                    <div class="container">
                      <div class="row plans pt-2">
                        <div
                          class="col card mr-xl-5 mr-lg-5 mr-md-4 mr-sm-4 mr-3"
                          onclick="window.location.href = 'choose/planA'"
                          style="cursor: pointer"
                        >
                          <p class="display-2">1</p>
                          <p style="font-size: large">month</p>
                          <p style="font-size: x-large">10 &#36;</p>
                        </div>
                        <div
                          class="col card mr-xl-5 mr-lg-5 mr-md-4 mr-sm-4 mr-3"
                          onclick="window.location.href = 'choose/planB'"
                          style="cursor: pointer"
                        >
                          <p class="display-2">6</p>
                          <p style="font-size: large">month</p>
                          <p style="font-size: x-large">45 &#36;</p>
                        </div>
                        <div
                          class="col card mr-xl-5 mr-lg-5 mr-md-4 mr-sm-4 mr-3"
                          onclick="window.location.href = 'choose/planC'"
                          style="cursor: pointer"
                        >
                          <p class="display-2">1</p>
                          <p style="font-size: large">year</p>
                          <p style="font-size: x-large">100 &#36;</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  watch: {
    ...
    renew_val: function () {
      axios
        .post(route('change-renew-setting'), { isRenew: this.renew_val })
        .then((res) => {
          if (res.data.status === 'success') {
            ...
            document.getElementById('notification-message').innerHTML +=
              "<li><i class='fas fa-exclamation-circle'></i>Renewal setting updated successfully.</li>";
          }
        })
        .catch((error) => {
          document.getElementById('notification').style.display = 'block';
          ...
          document.getElementById('notification-message').innerHTML +=
            "<li><i class='fas fa-exclamation-circle'></i>something went wrong, operation failed.</li>";
        });
    },
  },
};
