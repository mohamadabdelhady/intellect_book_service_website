  ...
  <div>
    <div class="results_tab">
      ...
      <a href="#" v-on:click.prevent="change_selected('audiobooks_results')">
        <span id="audiobooks_results" class="ml-3">Audio books ({{ audio.length }})</span></a
      >
      <a href="#" v-on:click.prevent="change_selected('authors_results')"
        ><span id="authors_results" class="ml-3">Authors ({{ authors.length }})</span></a
      >
      <hr style="width: 80vw" />
    </div>
    <div>
      <div id="ebook_results_area" style="display: none">
        ...
        <div v-else>
          <p style="font-size: medium">Sorry, we didn't find any results in e-books</p>
        </div>
      </div>
      <div id="audiobooks_results_area" style="display: none">
        ...
        <div v-else>
          <p style="font-size: medium">Sorry, we didn't find any results in Audio books</p>
        </div>
      </div>
      <div id="authors_results_area" style="display: none">
        ...
        <div v-else>
          <p style="font-size: medium">Sorry, we didn't find any results in Authors</p>
        </div>
      </div>
    </div>
  </div>
