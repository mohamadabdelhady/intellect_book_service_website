    ...
    <div class="row" id="reader_frame">
      <div id="epub_reader" class="col-10">
        <div id="full_screen_controllers" style="display: none" class="ml-2 mb-2 mt-1">
          <a href="#" v-on:click.prevent="previous_page"
        ...
        <a href="#" v-on:click.prevent="change_fontsize('+')"><i class="fas fa-plus-circle"></i></a> -->
          ...
          <a href="#" v-on:click.prevent="exit_fullScreen"
            ><i class="fas fa-times-circle fa-2x mr-2" style="float: right"></i
          ></a>
        </div>
      </div>
      ...
      <div class="mr-auto ml-auto mt-2">
        <span>
          <a href="#" v-on:click.prevent="change_fontsize('-')"
