<template>
  <div>
    ...
    <div class="mt-5">
      <p v-if="!review_data.length" class="txts" style="margin-left: 50px">
        There is no reviews on this book, be the first one to review it.
      </p>
      <div class="comments" v-for="(review, index) in review_data">
        <div>
          ...
          <span style="float: right"
            ><generate_stars :rating="review.rating"></generate_stars
          ></span>
        </div>
