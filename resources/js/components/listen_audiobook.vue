<template>
  <div>
    <div class="row">
      ...
      <div class="player">
        ...
        <div class="controllers row">
          <div class="m-auto">
            <a href="#" v-on:click.prevent="play_sound" class="ml-1"
              ><i class="fas fa-play fa-2x" style=""></i
            ></a>
            <a href="#" v-on:click.prevent="pause_sound" class="ml-1"
          ...
          <div>
            <span class="mr-2">
              <span>play rate</span>
              <a href="#" v-on:click.prevent="change_rate('-')"
            ...
            <a href="#" v-on:click.prevent="mute_sound" class="ml-1"
              ><i class="fas fa-volume-mute" style="" id="mute"></i
            ></a>
            <span>{{ volume }}%</span>
            <input
              type="range"
              ...
              class="seek-bar"
              id="volume"
              style="width: 5vw; margin-right: 50px"
            />
          </div>
        </div>
      </div>
    ...
    <hr />
    <div class="">
      <p align="center" class="txts">
        You can check the reviews other reader leave on this book, and make your own by going to the
        previous page
      </p>
      <p align="center">
        <button class="btn mt-2" v-on:click.prevent="go_check">Go check reviews</button>
      </p>
      <a
        :href="'check_audio_' + book_id"
        target="_blank"
        style="display: none"
        id="check_reviews"
      ></a>
